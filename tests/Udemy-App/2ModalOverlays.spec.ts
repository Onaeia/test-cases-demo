...
test('Modal & Overlays -> Dialog', async ({ page }) => {
...
test('Modal & Overlays -> Popover', async ({ page }) => {
    test.setTimeout(60000);
await page.goto('http://localhost:4200/');
await page.getByRole('link', { name: 'Modal & Overlays' }).click();
...
test('Modal & Overlays -> Toastr', async ({ page }) => {
    test.setTimeout(60000);
await page.goto('http://localhost:4200/');
await page.getByRole('link', { name: 'Modal & Overlays' }).click();
await page.getByRole('link', { name: 'Modal & Overlays' }).click();
...
test('Modal & Overlays -> Tooltip', async ({ page }) => {
    test.setTimeout(60000);
await page.goto('http://localhost:4200/');
await page.getByRole('link', { name: 'Modal & Overlays' }).click();
